...
public class BoardDBBean {
    ...
    public List<BoardDataBean> getMember(){
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        List<BoardDataBean> member1=null;
        ...
        try {
            ...
            if (rs.next()) {//해당 아이디에 대한 레코드가 존재
            	...
            	member1 = new ArrayList<BoardDataBean>();
            	do{  
            	  BoardDataBean member = new BoardDataBean();//데이터저장빈 객체생성
